...
| File | Purpose |
|------|---------|
| `src/index.ts` | The whole server — one `registerTool` call. |
...
### 2. Inspect & debug with the MCP Inspector
...
### 3. Test the raw protocol by hand
...
### 5. Connect to the Claude desktop app
